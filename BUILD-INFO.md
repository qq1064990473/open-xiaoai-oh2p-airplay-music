...
- 本版本：`open-xiaoai 1.4.0-airplay-music-ha.2`
...
- 发布文件：`client-airplay-music-ha-oh2p-armv7-glibc2.25-20260806`。
- 发布二进制大小：3,223,776 bytes。
...
当前二进制已安装到 OH2P，设备端 SHA-256 一致，HA 鉴权成功，ready 与 ASR-only 标记正常，AirPlay、音乐和原生事件监听均已启动。该 Client 不修改固件分区、麦克风通道或 ALSA 配置。
